...
![MVA_module() outputs folder/files part 1](figures/folder_structure_MVA.png){width="50%"}
...
![correlation with reordering](figures/03__correlation_plots.png){width="80%"}

![correlation plot sorted by conditions](figures/03__correlation_plots_condition.png){width="80%"}
...
![](figures/03__PCA_plots.png){width="70%"}
...
![](figures/03__PCA_plot_protein_level_conditions_marked.png){width="70%"}
...
![](figures/03__PCA_plot_protein_level_replicates_marked.png){width="70%"}
...
![](figures/03__PCA_plot_1st_to_5th_dimension__protein_level.png){width="70%"}
...
![](figures/03__PCA_plot_protein_level_measurement_order.png){width="70%"}
...
![](figures/03__PCA_plot_1st_5th_protein_measurement_order.png){width="60%"}
...
![](figures/03__PCA_plot_1st_to_5th_dimension__peptide_level.png){width="60%"}
...
![](figures/03__PCA_plot_1st_5th_peptide_measurement_order.png){width="60%"}
...
![](figures/03__UMAP_plot_protein_level_conditions_marked.png){width="60%"}
...
![HCPC_plots_peptide_level\_\_2D_map](figures/03__HCPC_plots_peptide_level__2D_map.png){width="60%"}

![HCPC_plots_peptide_level\_\_3D_map](figures/03__HCPC_plots_peptide_level__3D_map.png){width="60%"}

![HCPC_plots_peptide_level\_\_barplot](figures/03__HCPC_plots_peptide_level__barplot.png){width="60%"}

![HCPC_plots_peptide_level\_\_tree_plot](figures/03__HCPC_plots_peptide_level__tree_plot.png){width="60%"}

![HCPC_plots_protein_level\_\_2D_map](figures/03__HCPC_plots_protein_level__2D_map.png){width="60%"}

![HCPC_plots_protein_level\_\_3D_map](figures/03__HCPC_plots_protein_level__3D_map.png){width="60%"}

![HCPC_plots_protein_level\_\_barplot](figures/03__HCPC_plots_protein_level__barplot.png){width="60%"}

![HCPC_plots_protein_level\_\_tree_plot](figures/03__HCPC_plots_protein_level__tree_plot.png){width="60%"}
