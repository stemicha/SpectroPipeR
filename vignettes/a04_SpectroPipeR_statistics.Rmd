...
For more details about the peptide-level expression change averaging (PECA) procedure, see [Elo _et al._ (2005)](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC1316121/), [Laajala _et al._ (2009)](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC2728531/) and [Suomi _et al._ (2024)](https://www.bioconductor.org/packages/release/bioc/html/PECA.html)
...
**If "rots" is selected a Reproducibility-Optimized Test Statistic (ROTS) is calculated using the PECA package:**
...
The solid line shows the diagonal and the dashed lines indicate a 2-fold difference.
