...
![covariate adjustment example on simulated peptide data (left pannel: peptide intensities; right pannel: age adjusted peptide intensities)](figures/Covariate_adj_example.png){width="100%"}
