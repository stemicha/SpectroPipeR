#' Visualization of a correlation matrix using ggplot2 derived from the ggcorrplot package
#' @import ggplot2
#' @import reshape2
...
#' @param leg.lim define lower and upper limit for legend
#' @return
#' \itemize{
...
#' @keywords internal
#' @noRd
ggcorrplot_edited <- function (corr, method = c("square", "circle"),
