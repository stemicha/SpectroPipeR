...
message_function <- function(text = "", color = "blue", log_file_name = ""){
  ...
  if(color == "blue"){
    ...
    write(x = paste0("MESSAGE: ",text),file = log_file_name,append = T)
  }
  if(color == "red"){
    message(crayon::red(text))
    write(x = paste0("ERROR: ",text),file = log_file_name,append = T)
  }
  if(color == "green"){
  ...
  if(color == "yellow"){
    ...
    write(x = paste0("WARNING: ",text),file = log_file_name,append = T)
  }
  if(color == "magenta"){
